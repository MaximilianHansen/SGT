...
function Header({isMobile, isLeadGen, hamburgFunc, isHam, scrollTo}=this.props) {
      ...
      <div style={{ width:"100vw", display:"flex", alignItems:"center", flexDirection:'column', backgroundColor:'#f2f2f2'}}>
        <div style={{ width:"90%", display:"flex",justifyContent:"space-between", alignItems:'center', height: "10vh"}}>
          ...
          <div style={{display:'flex', flexDirection:"row"}}>
            <p onClick={scrollTo} style={{fontSize:"2em",cursor:"pointer" }}>How it Works</p>
        ...
        {isHam ?
          <div style={{ width:"100vw"}}>
            <div onClick={scrollTo}  style={{cursor:'pointer',  padding:'10px', borderTop:'black 1px solid',borderBottom:'black 1px solid',margin:'2px', height:'2em', display:'flex', justifyContent:'center', alignItems:'center', backgroundColor:'#f9f9f9'}}>
